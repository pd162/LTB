...
from mmocr.models.builder import DETECTORS, build_neck, build_head, build_backbone
...
class I3CL(BaseDetector):
    def __init__(self,
                 ...
                 init_cfg=None,
                 intracl_on=False):
        super(I3CL, self).__init__(init_cfg)
        if pretrained:
